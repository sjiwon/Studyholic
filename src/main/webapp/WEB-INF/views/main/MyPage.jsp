...
<div class="container col-md-6">
    ...
    <div class="col-md-12">
        <div class="col-md-6">
            ...
            <button class="btn btn-secondary btn-sm" type="button" onclick="editProfileToDefaultImage()">
                <spring:message code="mypage.change.profile.default"/>
            </button>
        </div>
        <br>
        <div class="col-md-12 row">
            <label for="image" class="form-label">
                <spring:message code="mypage.change.profile"/>
            </label>
            <div class="col-md-10" style="margin-bottom: 5px;">
                <input class="form-control" type="file" id="image">
            </div>
            <div class="col-md-2">
                <button class="btn btn-danger btn-sm" type="button" onclick="editProfileToCustomImage()">
                    <spring:message code="mypage.change.profile.process"/>
                </button>
            </div>
        </div>
        <br>
            ...
            <div class="card-body">
                <div class="col-md-12 row">
                    <div class="col-md-12">
                        <label for="name" class="form-label">
                            <spring:message code="mypage.name"/>
                        </label>
                ...
                <div class="col-md-12 row">
                    <label for="nickname" class="form-label">
                        <spring:message code="mypage.nickname"/>
                    </label>
                    <div class="col-md-10" style="margin-bottom: 5px;">
                        <input class="form-control" type="text" id="nickname" value="${userDetail.basicUser.nickname}" readonly>
                    </div>
                    <div class="col-md-2">
                        <button id="nicknameEditButton" class="btn btn-danger btn-sm" type="button" onclick="editNicknameButtonEnable()">
                            <spring:message code="mypage.change.nickname"/>
                        </button>
                    </div>
                </div>
                <br>
                ...
                <div class="col-md-12 row">
                    <label for="loginPassword" class="form-label">
                        <spring:message code="mypage.password"/>
                    </label>
                    <div class="col-md-10" style="margin-bottom: 5px;">
                        <input class="form-control" type="password" id="loginPassword" value="<%=UUID.randomUUID().toString()%>" readonly>
                    </div>
                    <div class="col-md-2">
                        <button id="passwordEditButton" class="btn btn-danger btn-sm" type="button" onclick="moveToEditPasswordPage()">
                            <spring:message code="mypage.change.password"/>
                        </button>
                    </div>
                </div>
                <br>
                ...
                <div class="col-md-12 row">
                    <div class="col-md-12">
                        <label for="birth" class="form-label">
                            <spring:message code="mypage.birth"/>
                        </label>
                ...
                <div class="col-md-12 row">
                    <div class="col-md-12">
                        <label for="email" class="form-label">
                            <spring:message code="mypage.email"/>
                        </label>
